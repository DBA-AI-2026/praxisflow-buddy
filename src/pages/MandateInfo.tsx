 ...
 * `mandate-link`-Endpoint bei allen nicht-eligiblen Fällen weiterleitet
 * (kein contract_id, ungültige UUID, nicht gefunden, falscher Status,
 * kein stripe_customer_id, DB/Stripe-Fehler).
 *
 * Bewusst identischer Inhalt für alle Fälle — keine Enumeration,
 * kein Leak, ob eine UUID existiert.
 */
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="px-8 pb-8 pt-4 text-center space-y-4">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Der Aktivierungslink ist entweder abgelaufen, wurde bereits verwendet
