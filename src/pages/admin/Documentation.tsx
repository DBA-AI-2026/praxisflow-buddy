...
const flows: Flow[] = [
  {
    ...
    steps: [
      ...
      { id: "s6", label: "Qualifizierung", description: "Admin/Vertrieb setzt Status: new → contacted → qualified / rejected", type: "decision" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "t6", label: "Admin/Vertriebsleitung prüft", description: "Zentrale Verwaltung unter /admin/tipp-leads", type: "decision" },
