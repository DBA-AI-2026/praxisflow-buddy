...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'E-Mail-Adresse bestätigen – HFX Sales Portal',
  invite: 'Einladung zum HFX Sales Portal',
  magiclink: 'Ihr Login-Link – HFX Sales Portal',
  recovery: 'Passwort zurücksetzen – HFX Sales Portal',
  email_change: 'E-Mail-Änderung bestätigen – HFX Sales Portal',
  reauthentication: 'Ihr Bestätigungscode – HFX Sales Portal',
}
...
// Configuration
const SITE_NAME = "HFX Sales Portal"
const SENDER_DOMAIN = "notify.sales.hfx-honorarfuchs.de"
const ROOT_DOMAIN = "sales.hfx-honorarfuchs.de"
const FROM_DOMAIN = "sales.hfx-honorarfuchs.de" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://praxisflow-buddy.lovable.app"
