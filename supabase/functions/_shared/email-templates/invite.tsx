...
export const InviteEmail = ({
  ...
  <Html lang="de" dir="ltr">
    <Head />
    <Preview>Einladung zum HFX Sales Portal</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          <Link href={siteUrl} style={link}>
            <strong>HFX Sales Portal</strong>
          </Link>{' '}
          eingeladen. Klicken Sie auf den Button, um Ihr Konto zu erstellen.
        </Text>
        <Button style={button} href={confirmationUrl}>
          Einladung annehmen
        </Button>
        <Text style={footer}>
          Falls Sie keine Einladung erwartet haben, können Sie diese E-Mail ignorieren.
        </Text>
